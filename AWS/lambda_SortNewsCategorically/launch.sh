...
# Copy SortNewsCategorically.py to the site-packages directory
cp ../../../../SortNewsCategorically.py .
...
# Name of the Lambda function for SortNewsCategorically
LAMBDA_FUNCTION_NAME="SortNewsCategorically"

# Role ARN for the Lambda function
AWS_ROLE_ARN="arn:aws:iam::402692462524:role/SortNewsCategorically"
...
if aws lambda get-function --function-name $LAMBDA_FUNCTION_NAME; then
    ...
    aws lambda create-function --function-name $LAMBDA_FUNCTION_NAME \
        ...
        --handler SortNewsCategorically.lambda_handler \
        --runtime python3.9 \
        --role $AWS_ROLE_ARN
fi
